...
class LayoutTest(unittest.TestCase):
    def test_expected_paths_exist(self) -> None:
        expected = [
            ...
            ROOT / "scripts" / "verify-release-readback.sh",
            ...
            ROOT / "scripts" / "check-reproducible-build.ps1",
            ...
            ROOT / "scripts" / "verify-release-readback.ps1",
            ...
            ROOT / "scripts" / "check-reproducible-build.cmd",
            ...
            ROOT / "scripts" / "verify-release-readback.cmd",
